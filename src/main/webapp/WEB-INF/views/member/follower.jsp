...
<h2>팔로워</h2>
<br><br><br>
<c:forEach var="followingMembervo1" items="${followerMembervo1}" varStatus="status">
<input class="follower_delete" type="hidden">
	<div class="wrapper">	
     <div class="left">
        <img src="<c:url value="/img/${followerMembervo2[status.index].pet_fname}"/>"  width="80" hight="80" align="middle">
        </div>
        <!-- 가운데 -->
        ...
        <!-- 오른쪽 -->
        <div class="right">
        <button onclick="follower_delete(${followingMembervo1.member_number});" class="btn btn-primary mt-4">삭제</button>
        </div>
	</div>
<br><br><br>
		</c:forEach>
...
<script>
function follower_delete(member_number) {
	$('follower_delete').val(member_number);
