...
<section class="w3l-contact-1 pt-5"id="contact">
  <div class="contacts-9 pt-lg-4" style="min-height: 480px;">
      <h5 class="sub-title text-center mb-2">With Us!</h5>
      <h3 class="hny-title text-center mb-5">로그인</h3>
          ...
          <div class="d-grid">
              ...
              <div class="map-content-9 mt-lg-0 mt-md-4 mt-2">
                  ...
                  <form action="login.do" method="post">
                     ...
                     <div>
                      <button onclick="loginCheck()"  id="loginCheck" class="btn btn-primary mt-4">로그인</button>
                      </div>       
