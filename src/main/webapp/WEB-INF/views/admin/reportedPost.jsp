            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12"><br/><br/>
                        <div class="card" style="width:140%;margin-left:-24%;">
                            <div class="card-body" style="padding:3rem;">
                            
                                <h4 class="card-title">신고사유 : 부적절한 언어 사용</h4>
                                <div class="bootstrap-media">
                                    <div class="media" style="width:100%;">
                                        <img class="mr-3 img-fluid" src="../assets/images/admin/avatar/1.jpg" alt="Generic placeholder image">
                                        ...
                                        <div class="button-group" style="margin-left:3%;position:right;">
		                                    <div class="btn-group-vertical">
		                                        <button class="btn btn-primary" type="button">메시지 전송</button>
		                                        <button class="btn btn-primary" type="button">게시물 삭제</button>
		                                    </div>
		                                </div>
                                    </div>
                                </div><hr/>
