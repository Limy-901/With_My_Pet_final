...
<head>
    ...
    <title>:: 관리자 :: With My Pet :: 함께 산책해요 </title>
    <!-- 발자국 아이콘 -->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header" style="background-color:white;">
            <div class="brand-logo" style="display:flex; margin:auto;">
                <a href="index.html" style="display:flex; margin:auto;">
                    <span class="brand-title" style="display:flex; margin:auto; ">
                        <img style="display:flex; margin:auto; width:80%;"src="../assets/images/logos/logo-yellow.png" alt=""><br/><br/>
                    </span>
                </a>
            </div>
        </div>
        ...
        ***********************************-->
        ...
        <!--**********************************
            Header start
        ***********************************-->
        <div class="header" style="background-color:#FEE4B1;">    
                    ...
                    <ul class="clearfix">
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                                ...
                                <img src="../assets/images/admin/user/1.png" height="40" width="40" alt="">
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div id="activity">
                                    <div class="media border-bottom-1 pt-3 pb-3">
                                        <img width="35" src="../assets/images/admin/avatar/1.jpg" class="mr-3 rounded-circle">
                                    ...
                                    <div class="media border-bottom-1 pt-3 pb-3">
                                        <img width="35" src="../assets/images/admin/avatar/2.jpg" class="mr-3 rounded-circle">
                                        <div class="media-body">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img width="35" src="../assets/images/admin/avatar/3.jpg" class="mr-3 rounded-circle">
                                        <div class="media-body">
