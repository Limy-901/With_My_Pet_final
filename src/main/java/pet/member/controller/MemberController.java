...
public class MemberController {
      ...
      public String postJoin(@ModelAttribute MemberVO vo ,  HttpServletRequest request) throws Exception {
         ...
         try {
            if(result == 1) {
               ...
               logger.info("회원가입 왔어염 : " + vo.getMember_email() + ", "+vo.getMember_password() + ", "+vo.getMember_name() + ", " + vo.getMember_address());
   ...
   public String mypage() {
		//log.info("회원가입 왔어염 : " + vo.getEmail() + ", "+vo.getPassword() + ", "+vo.getName() + ", " + vo.getAddress());
		return "/pet/mypage";
	}
